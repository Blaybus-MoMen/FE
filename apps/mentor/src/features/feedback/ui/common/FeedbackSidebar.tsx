...
const FeedbackSidebar = ({
    ...
    return (
        <aside className="flex z-50 lg:min-h-screen lg:h-full w-full lg:w-[430px] flex-col bg-primary-blue pt-6 lg:pt-10 text-white shadow-[6px_0_20px_rgba(0,0,0,0.15)]">
                ...
                <div className="flex flex-col gap-4 items-start sm:flex-row sm:gap-6">
                    ...
                    <div className="flex gap-6">
                        <h3
                            ...
                            onClick={() => navigate(`/mentoring/${selectedMenteeId}/manage`)}
                        >
                            학습관리
                        </h3>
            ...
            <div className="flex flex-1 min-h-0 flex-col">
                <div className="mx-4 lg:mx-0 mb-6">
                    <div className="w-full lg:w-[370px] lg:ml-auto rounded-[24px] lg:rounded-l-[24px] lg:rounded-r-none bg-white p-4 shadow">
