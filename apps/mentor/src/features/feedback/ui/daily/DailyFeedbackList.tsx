...
const FeedbackList = () => {
    ...
    return (
        <section className="flex flex-1 flex-col gap-6 min-h-0 px-4 lg:px-10 pb-10">
            <div className="flex items-start justify-end lg:justify-between gap-4">
                ...
                <div className="hidden lg:flex gap-3">
                    ...
                    <button
                        className="flex h-[42px] w-[42px] items-center justify-center rounded-full bg-primary-blue-dark text-white shadow-xl"
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-5 overflow-y-auto no-scrollbar">
                <FeedbackCard subject="국어" task="독서 2지문" isConfirmed={true} goal="문항 독해력 향상" />
                <FeedbackCard subject="영어" task="영어 1단원 본문" isConfirmed={true} goal="문법 학습" />
                <FeedbackCard subject="수학" task="확률과 통계" isConfirmed={false} goal="계산 능력 향상" />
                <FeedbackCard subject="수학" task="확률과 통계" isConfirmed={false} goal="계산 능력 향상" />
                <FeedbackCard subject="영어" task="영어 1단원 본문" isConfirmed={true} goal="문법 학습" />
            </div>
