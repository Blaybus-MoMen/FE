...
const LoginForm = () => {
    return (
        <form
            className="w-full h-full max-w-[600px] max-h-[602px] rounded-3xl bg-[linear-gradient(180deg,#94DBFB_0%,#FFFFFF_100%)] shadow-[0px_0px_30.2px_0px_#00000029] pt-16 pb-[53px] px-[71px]"
        >
            <h1 className="text-grayscale-dark-gray">멘토 로그인</h1>
            <h5 className="text-grayscale-dark-gray mt-4">관리자모드 로그인하세요.</h5>
            <div className="flex flex-col gap-5 mt-12">
                <div className="w-full max-w-[458px] h-14 flex items-center border border-grayscale-border rounded-full pl-6 pr-4 py-4 bg-[#FFFFFF] shadow-[inset_0px_0px_4px_0px_#00000040]">
                ...
                <div className="w-full max-w-[458px] h-14 flex items-center border border-grayscale-border rounded-full pl-6 pr-4 py-4 bg-[#FFFFFF] shadow-[inset_0px_0px_4px_0px_#00000040]">
                    ...
                    <div className="flex-1 min-w-0 flex items-center">
                        <input
                            type="password"
                            className="w-full border-0 p-0 bg-transparent outline-none placeholder:text-grayscale-light-gray"
            ...
            <button className="w-full max-w-[458px] h-14 bg-primary-blue text-white rounded-full px-6 py-4 mt-12 ui-button">로그인</button>
