...
const FeedbackPage = () => {
    ...
    return (
        <main className="relative h-full w-full overflow-hidden bg-feedback-layout">
            <div className="flex h-full w-full">
                ...
                <section className="flex flex-1 flex-col bg-primary-blue-pale">
                    <header className="flex items-center justify-between px-10 py-8">
                        <div className="ml-auto flex items-center gap-[9px] rounded-[100px] bg-[#666666]/30 pl-[20px] shadow-[inset_0px_2px_4px_1px_#00000040]">
