    ...
    return (
        ...
        >
            ...
            <main className="flex-1 overflow-auto min-h-0 p-4">
                ...
                <div className="mt-[27px] bg-[#FEFEFE] h-[135px] shadow-[0px_0px_7px_0px_#0000002B] rounded-[15px] flex items-center justify-center flex-col gap-[6px]">
                    <FilePlus size={20} />
                    <p className='text-[10px] text-[#828282]'>파일 추가</p>
                </div>
                <textarea className="mt-[14px] w-full bg-[#FEFEFE] h-[135px] shadow-[0px_0px_7px_0px_#0000002B] rounded-[15px] resize-none p-[14px] outline-none focus:outline-none text-[16px]" placeholder='학습한 내용을 작성해주세요.' />
                <button
                    type="button"
